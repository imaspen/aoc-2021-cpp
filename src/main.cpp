...
#include "days/day_19.hpp"
#include "days/day_20.hpp"
#include "days/day_21.hpp"
#include "days/day_22.hpp"
#include "days/day_23.hpp"
#include "days/day_24.hpp"
#include "days/day_25.hpp"
...
int main(int argc, const char* argv[])
{
	...
	try
	{
		...
		case 18:
			...
			break;
		case 19:
			day_ptr = std::make_unique<aoc::day_19>(input);
			break;
		case 20:
			day_ptr = std::make_unique<aoc::day_20>(input);
			break;
		case 21:
			day_ptr = std::make_unique<aoc::day_21>(input);
			break;
		case 22:
			day_ptr = std::make_unique<aoc::day_22>(input);
			break;
		case 23:
			day_ptr = std::make_unique<aoc::day_23>(input);
			break;
		case 24:
			day_ptr = std::make_unique<aoc::day_24>(input);
			break;
		case 25:
			day_ptr = std::make_unique<aoc::day_25>(input);
			break;
		default:
